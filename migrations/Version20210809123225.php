 ...
 */
final class Version20210809123225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT UNSIGNED AUTO_INCREMENT NOT NULL, category_id INT UNSIGNED NOT NULL, currency_id INT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, geo_info LONGTEXT DEFAULT NULL, source_traffic LONGTEXT DEFAULT NULL, forbidden_sources LONGTEXT DEFAULT NULL, pay_sum DOUBLE PRECISION UNSIGNED DEFAULT \'0\' NOT NULL, image_filename VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_29D6873E12469DE2 (category_id), INDEX IDX_29D6873E38248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
