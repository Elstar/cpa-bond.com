 ...
 */
final class Version20210915101817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE balance_operations (id INT AUTO_INCREMENT NOT NULL, lead_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED NOT NULL, sum DOUBLE PRECISION NOT NULL, operation_type INT UNSIGNED DEFAULT 0 NOT NULL COMMENT \'0 - with lead, 1 - payOuts\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_70B7556A55458D (lead_id), INDEX IDX_70B7556AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pay_out_methods (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, convert_rate DOUBLE PRECISION UNSIGNED DEFAULT \'1\' NOT NULL, commission DOUBLE PRECISION UNSIGNED DEFAULT \'0\' NOT NULL, active TINYINT(1) DEFAULT \'1\' NOT NULL COMMENT \'false - not active, true - active\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE payment_detail (id INT AUTO_INCREMENT NOT NULL, pay_out_methods_id INT NOT NULL, detail_property VARCHAR(255) NOT NULL, INDEX IDX_B3EE405E4909390 (pay_out_methods_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE payout (id INT AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, payment_system_id INT NOT NULL, sum INT UNSIGNED NOT NULL, status INT UNSIGNED DEFAULT 0 NOT NULL COMMENT \'0 - new, 1 - payed, 2 - reject\', reason VARCHAR(255) DEFAULT NULL COMMENT \'reason of reject\', final_sum DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_4E2EA902A76ED395 (user_id), INDEX IDX_4E2EA90293BC008D (payment_system_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE payment_detail ADD CONSTRAINT FK_B3EE405E4909390 FOREIGN KEY (pay_out_methods_id) REFERENCES pay_out_methods (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment_detail DROP FOREIGN KEY FK_B3EE405E4909390');
        $this->addSql('ALTER TABLE payment_system DROP FOREIGN KEY FK_EC758A1DE02E02B0');
        ...
        $this->addSql('ALTER TABLE payout DROP FOREIGN KEY FK_4E2EA90293BC008D');
        ...
        $this->addSql('ALTER TABLE payment_system DROP FOREIGN KEY FK_EC758A1DA76ED395');
        ...
        $this->addSql('DROP TABLE pay_out_methods');
